  ...
  return (
    <div className="main-page">
      <header>
        ...
        <h1>Discover New Ireland</h1>
        <p>Author's tours to exotic places from Oleg</p>

        <div
          style={{ display: "flex", alignItems: "center", marginTop: "90px" }}
        >
          <button id="request-btn">Leave a request</button>
          <svg
            width="75"
            height="75"
            viewBox="0 0 75 75"
          ...
          >
            <g clip-path="url(#clip0_3_25)">
              <g opacity="0.75">
                ...
                <path
                  opacity="0.75"
                  d="M32.25 28.4067L48 37.5L32.25 46.5933V28.4067Z"
                  stroke="white"
                  stroke-width="2"
                />
              </g>
        ...
        >
          <div className="first" style={{ marginTop: "120px"}}>
            <p>Subscribe on social networks</p> <br />
